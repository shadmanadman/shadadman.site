...
title: jul-22-2017-MarketMLM_Offline_First
---
...
- We faced a new decision on what to use for local database and what section should be offline-first:
    - For this we asked ourself a couple of questions:
        1. whats the domain of platform?  its e-commerce that uses wordpress.
        2. Since its product based, Do we need to make the home page offline and store products?
           it would be good for ux but we decided not do that. one reason was
           price of the product was changing by minutes.
        2. Do we need to make the profile offline available?
        ...
        3. What other section would be good for ux to be offline-first?
